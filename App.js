...
import shopping_cart from "./Assests/shopping_cart.svg";
import search_icon from "./Assests/search_icon.svg";
import Pizzaimage from "./Assests/Pizza image.png";
...
const Restaurantcard = (props) => {
  const { resData } = props;
  const { cloudinaryImageId, cuisines, name, costForTwo } = resData?.info;
...
const resList = [
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-12-29 04:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
    ...
    analytics: {
      context: "seo-data-61d4333a-f721-4d4a-a599-6b5879bcba12",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-12-29 03:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-12-29 02:59:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      name: "Subway",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/12/9/28bacc3b-d4dc-482a-86e3-cab0547a9c78_614570.JPG",
      locality: "Sector 10",
      areaName: "Rohini",
      costForTwo: "₹350 for two",
      ...
      availability: {
        nextCloseTime: "2024-12-29 01:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-12-29 05:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
